...
class Engineer(Person):
    ...
    def get_price(self):
        ...
        self.price = int(math.floor(Consts.BASE_PRICE[self.job] * math.sqrt(Consts.MIN_AGE / self.age)))
    ...
    def calc_life_cost(self):
        ...
        self.cost = int(math.floor(Consts.BASE_COST[self.job] * math.sqrt(self.age / Consts.MIN_AGE)))
    ...
    def calc_income(self):
        ...
        self.income = int(math.floor(Consts.BASE_INCOME[self.job][self.work_place.get_expertise()] * math.sqrt(Consts.MIN_AGE / self.age) ))
